        ...
        <div className="bg-darkblue py-10 flex items-center">
            <div className="container">
                ...
                <div className="flex flex-col md:flex-row mt-3 text-white gap-3">
                    <a href="mailto:sridhar@konceptsdandd.com" className="no-underline text-white"><button className=" border-2 border-white px-3 py-2 text-xl md:text-2xl font-bold text-white rounded-lg transition-all duration-500 hover:rounded-tr-3xl hover:rounded-bl-3xl font-ContentText">Email us Today</button></a>
