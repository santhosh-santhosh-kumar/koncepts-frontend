import Travel from "../../assets/animated-icons/services/travel.webm";
import automotive from "../../assets/animated-icons/services/automobile.webm";
import ecommerce from "../../assets/animated-icons/services/ecommerce.webm";
import retail from "../../assets/animated-icons/services/retail.webm";
import hospitality from "../../assets/animated-icons/services/hospitality.webm";
import realestate from "../../assets/animated-icons/services/realestate.webm";
import education from "../../assets/animated-icons/services/meeting.webm";
import event from "../../assets/animated-icons/services/event1.webm";
import healthcare from "../../assets/animated-icons/services/healthcare.webm";
            ...
            <div className="container">
                        ...
                        <div key={index} className="flex flex-col justify-center items-center mt-10">
                            <div className="border-dashed border-2 border-darkblue rounded-full p-4 md:p-5 w-fit relative">
                                ...
                                <div className="w-20 md:w-24 h-20 md:h-24 rounded-full">
                                    <video className="w-full h-full object-contain" src={item.icon} autoPlay loop muted />
                                </div>
                                <p className="w-6 h-6 rounded-full left-2 bottom-1 bg-darkblue absolute"></p>
                            </div>
                            <h3 className="text-xl mt-2 text-darkblue font-bold">{item.title}</h3>
                        </div>
                    ))}
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-5 mt-5 justify-center px-0 md:px-32">
                    {verticals.slice(4, 7).map((item, index) => (
                        <div key={index} className="flex flex-col justify-center items-center mt-3">
                            <div className="border-dashed border-2 border-darkblue rounded-full p-4 md:p-5 w-fit relative">
                                <div className="absolute -top-3 left-24 px-[7px] py-[5px] rounded-full flex shadow-md shadow-darkblue bg-white">
                                    <p className="mx-auto my-auto text-darkblue font-bold text-xl">
                                        {`0${item.id}`}
