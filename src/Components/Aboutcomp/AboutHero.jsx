  ...
  return (
    <div className='w-full h-screen md:pt-20 flex flex-col text-center'>
      ...
      <div className='md:py-40 py-20'>
          <button onClick={moveteam} className='border-2 border-dashed border-gray-400 w-fit mx-auto rounded-lg p-3 flex items-center transition-all duration-300 hover:scale-95'>
