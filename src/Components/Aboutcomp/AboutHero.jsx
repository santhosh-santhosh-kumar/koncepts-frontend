  ...
  return (
    <div className='w-full h-screen md:pt-20 flex flex-col text-center'>
      ...
      <div className='md:py-40 py-20'>
          <button onClick={moveteam} className='group border-2 border-dashed border-gray-400 w-fit mx-auto px-5 py-3 flex items-center transition-all duration-700 hover:rounded-br-lg hover:rounded-tl-lg hover:rounded-tr-3xl hover:rounded-bl-3xl'>
            ...
            <FaArrowDown  className='group-hover:animate-bounce w-5 h-5 text-darkblue mt-2'/>
          </button>
      </div>
    </div>
  )
